  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-sky-600 text-left mb-4">
            หมวดหมู่สินค้า <span className="text-sky-500 text-3xl">🎵</span>
          </h2>
          <div className="h-[3px] bg-gradient-to-r from-yellow-400 to-yellow-100 w-full mb-12 rounded-full" />
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl text-sky-600 font-bold text-left mb-12">
            สินค้าใหม่ <span className="text-sky-500 text-3xl">🎵</span>
          </h2>
          <div className="h-[3px] bg-gradient-to-r from-yellow-400 to-yellow-100 w-full mb-12 rounded-full" />
          <NewBook />
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl text-sky-600 font-bold text-left mb-12">
            สินค้าแนะนำ <span className="text-sky-500 text-3xl">🎵</span>
          </h2>
          <div className="h-[3px] bg-gradient-to-r from-yellow-400 to-yellow-100 w-full mb-12 rounded-full" />
          <FeaturedBooks />
